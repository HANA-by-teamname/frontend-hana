...
| 화면 이름 | 미리보기 |
|-----------|----------|
| 로그인 화면 | ![](./asset/로그인\ 화면.png) |
| 홈 화면 | ![](./asset/홈\ 화면.png) |
| 회원가입 선택 화면 | ![](./asset/회원가입\ 선택.png) |
| 회원가입 온보딩 화면 | ![](./asset/회원가입\ 온보딩.png) |
| 마이페이지 - 재학생 인증 | ![](./asset/마이페이지_재학생인증.png) |
| 검색 | ![](./asset/검색.png) |
| 검색 필터 | ![](./asset/검색_필터.png) |
| 스프린트 | ![](./asset/스프린트.png) |
| 시간표 등록 | ![](./asset/시간표.png) |
| 오류 안내 | ![](./asset/오류.png) |
| 챗봇 | ![](./asset/챗봇.png) |
| 카카오톡 연동 | ![](./asset/카카오톡.png) |
